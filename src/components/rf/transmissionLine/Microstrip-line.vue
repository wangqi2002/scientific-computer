                ...
                <div class="top">
                    <div class="top_top line">
                        <table cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                                <td rowspan="4">
                                    <img class="slit_img" src="@/assets/rf/microstrip_line.gif" />
                                </td>
                                <td>
...
const handleAnalyze = () => {
    ...
    if ((formData.er !== undefined && formData.er !== '') || (formData.h !== undefined && formData.h !== '') || (formData.t !== undefined && formData.t !== '') || (formData.f !== undefined && formData.f !== '')) {
        setFormData(microstripAnalyze(formData))
    } else {
        ElMessage('请输入数据')
    }
}
const handleSvnthesis = () => {
    let formData = getFormData()
    if ((formData.er !== undefined && formData.er !== '') || (formData.h !== undefined && formData.h !== '') || (formData.t !== undefined && formData.t !== '') || (formData.f !== undefined && formData.f !== '')) {
        setFormData(microstripSvnthesis(formData))
    } else {
        ElMessage('请输入数据')
    }
}
